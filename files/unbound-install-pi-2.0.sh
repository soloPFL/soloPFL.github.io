...
# create a cron job to update root hints once a month
sudo bash -c 'echo "0 0 1 * * wget -O /var/cache/unbound/root.hints https://www.internic.net/domain/named.cache && sudo systemctl restart unbound" >> /etc/cron.monthly/unbound_update'
